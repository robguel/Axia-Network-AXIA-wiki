...
slug: ../../maintain-guides-society-axialunar
---

Kappa Sigma Mu is a membership club using the Axlib [Society][axlib pallet] pallet. It is an
...
rewards paid by the treasury. Currently, there is only one society on AXIALunar but it is possible to
have multiple societies in the future through a runtime upgrade.

![Society Dashboard](../../assets/axialunar/axialunar_society_page.png)
![Society Dashboard](../../assets/axialunar/axialunar_society_page2.png)

Before joining the society, let's take a brief look at the
[Society UI](https://AXIA.js.org/apps/#/society) on AXIA-JS apps and read through all the
...
is defined [in the society pallet][axlib pallet] if you would like to have a look.
...
[axlib pallet]: https://axlib.dev/rustdocs/latest/pallet_society/index.html
