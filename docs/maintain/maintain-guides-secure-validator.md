...
- [Telemetry](https://github.com/axia-tech/axlib-telemetry) This tracks your node details
...
- [Prometheus](https://prometheus.io/)-based monitoring stack, including
  ...
  from `axlib-telemetry` can be made available to Prometheus through exporters like
  [this](https://github.com/axia-tech/axlib-telemetry-exporter).
...
- At the moment, AXIA/Axlib can't interact with HSM/SGX, so we need to provide the signing
