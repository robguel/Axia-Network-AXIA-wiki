...
tackle yourself. Being a validator involves more than just executing the AXIA binary.**
...
[nominators](../learn/learn-nominator.md). This means that as a minimum, you will need enough AXC to set up
...
**Warning:** Any AXC that you stake for your validator is liable to be slashed, meaning that an
insecure or improper setup may result in loss of AXC tokens! If you are not confident in your
ability to run a validator node, it is recommended to nominate your AXC to a trusted validator node
instead.
...
[here](https://github.com/axia-tech/axlib/pull/5848).
...
2021-06-17 03:07:07 📋 Chain specification: AXIA
2021-06-17 03:07:07 🏷 Node name: boiling-pet-7554
2021-06-17 03:07:07 👤 Role: FULL
2021-06-17 03:07:07 💾 Database: RocksDb at /root/.local/share/AXIA/chains/AXIA/db
2021-06-17 03:07:07 ⛓  Native runtime: AXIA-9050 (axia-AXIA-0.tx7.au0)
...
[Telemetry](https://telemetry.AXIA.io/#list/AXIA%20CC1) or the
[AXIAJS Block Explorer](https://AXIA.js.org/apps/#/explorer).
...
Make sure not to bond all your AXC balance since you will be unable to pay transaction fees from
your bonded balance.

It is now time to set up our validator. We will do the following:

- Bond the AXC of the Stash account. These AXC will be put at stake for the security of the network
  and can be slashed.
...
![dashboard bonding](../assets/guides/how-to-validate/AXIA-dashboard-bonding.png)

- **Stash account** - Select your Stash account. In this example, we will bond 1 AXC, where the
...
![sign transaction](../assets/guides/how-to-validate/AXIA-authorize-transaction-stash.png)
...
![stash overview](../assets/guides/how-to-validate/AXIA-stash-overview.png)
...
> [hasKey](https://AXIA.js.org/docs/axlib/rpc/#haskeypublickey-bytes-keytype-text-bool) to
> check for a specific key or
> [hasSessionKeys](https://AXIA.js.org/docs/axlib/rpc/#hassessionkeyssessionkeys-bytes-bool)
...
2021-06-17 03:12:08 📋 Chain specification: AXIA
2021-06-17 03:12:08 🏷 Node name: nateched-test
2021-06-17 03:12:08 👤 Role: AUTHORITY
2021-06-17 03:12:08 💾 Database: RocksDb at /root/.local/share/AXIA/chains/AXIA/db
2021-06-17 03:12:08 ⛓  Native runtime: AXIA-9050 (axia-AXIA-0.tx7.au0)
...
you are doing this, make sure that you have the AXIAJS-Apps explorer attached to your validator
...
[Telemetry](https://telemetry.AXIA.io/#list/AXIA%20CC1) and find your node. Note that this
will show all nodes on the AXIA network, which is why it is important to select a unique name!

In this example, we used the name `techedtest` and have successfully located it upon searching:

![dashboard validate](../assets/guides/how-to-validate/AXIA-dashboard-telemetry.png)

### Setup via Validator Tab

![dashboard validate](../assets/guides/how-to-validate/AXIA-dashboard-validate-1.png)
...
![dashboard validate](../assets/guides/how-to-validate/AXIA-dashboard-validate-2.png)
...
![staking queue](../assets/guides/how-to-validate/AXIA-dashboard-staking.png)
...
increase the number of AXC staked or seek out nominators for your validator in order to join the
validator set.
