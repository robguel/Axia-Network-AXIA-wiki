...
If you're building dapps or products on a Axlib-based chain like AXIA, or a custom
Axlib implementation, you probably want the ability to run a node-as-a-back-end. After all, it's
...
same process applies to any other [Axlib](https://axlib.dev/docs/en/)-based chain. First,
...
format](https://github.com/axia-tech/axlib-light-ui) as well as a full or light node that is
...
[here](https://axlib.dev/docs/en/knowledgebase/getting-started) - note that Windows users will
