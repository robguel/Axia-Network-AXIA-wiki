...
proxy for websocket connections. Let's see how we can set up WSS on a remote Axlib node.
...
Whether it's a generic Axlib node, or your own private blockchain, they all
...
using Ubuntu 18.04. Then install Axlib and build the node.
