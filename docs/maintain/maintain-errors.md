...
Errors in Axlib-based chains are usually accompanied by descriptive messages. However, to read
...
we will check the Balances pallet's code which is hosted in the Axlib repository, and look for
the fourth error in the Error enum. According to
[its source](https://github.com/axia-tech/axlib/blob/master/frame/balances/src/lib.rs#L396) the
error that we got is
[InsufficientBalance](https://github.com/axia-tech/axlib/blob/master/frame/balances/src/lib.rs#L402)
