...
<!-- https://github.com/axlib-developer-hub/axlib-developer-hub.github.io/issues/965 -->
...
[Recovery Pallet](https://axlib.dev/docs/en/knowledgebase/runtime/frame#recovery), so this is
...
Currently, {{ AXIA: AXIA :AXIA }} does not use the
[Assets Pallet](https://axlib.dev/docs/en/knowledgebase/runtime/frame#assets), so this is
probably not the reason for your tokens having existing references.
