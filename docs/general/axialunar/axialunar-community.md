...
- [Axlib Technical](https://app.element.io/#/room/#axlib-technical:matrix.org) - More
  advanced room for technical questions on building with Axlib.
- [Smart Contracts & AXIA Ink!](https://app.element.io/#/room/!tYUCYdSvSYPMjWNDDD:matrix.axia.io?via=matrix.axia.io&via=matrix.org&via=AXIA.org) -
  A room to discuss developing Axlib smart contracts using AXIA Ink!
