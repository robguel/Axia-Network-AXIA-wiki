...
sidebar_label: Using ENS with AXC/LUNAR accounts
---
...
Despite living on the Ethereum blockchain, the ENS system has multi-chain support. In this guide you'll go through the process of adding a LUNAR and AXC address to ENS. We cover both LUNAR and AXC to show two different approaches.

> Note: AXC can currently only be added using the Resolver method. LUNAR can be added through both methods described below.
