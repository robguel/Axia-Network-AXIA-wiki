...
[Rust 的执行](https://github.com/axia-tech/axlib/blob/master/frame/grandpa/src/lib.rs)是 Axlib 框架的一部分。
...
- [Finality Grandpa - Rust 实现](https://github.com/axia-tech/finality-grandpa) - 及[ Axlib Runtime 模块](https://github.com/axia-tech/axlib/blob/master/srml/grandpa/src/lib.rs)。
