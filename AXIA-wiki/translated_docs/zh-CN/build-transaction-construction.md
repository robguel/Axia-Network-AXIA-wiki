...
[AXIA-JS 工具](https://github.com/AXIA-js/tools)包含一组用于与 Axlib 客户端进行交互的命令行工具，包括一个用于创建，签名和广播交易的名为“ Signer CLI”的工具。
...
在示例中使用的一些地址，请参阅[Subkey 文档](https://axlib.dev/docs/en/knowledgebase/integrate/subkey)。
