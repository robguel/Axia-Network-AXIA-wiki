...
如果开发者想要开始在基于 Axlib 的平行链上开发并部署智能合约，可以参考这个列表的资源：

- [Edgeware 合约](https://contracts.edgewa.re) - Edgeware 合约的文档。
- [ink!](https://github.com/axia-tech/ink) - Axia 提供的编写智能合约的 ink。
- [Axlib 合约工作坊](https://axlib.dev/axlib-contracts-workshop/#/) - 指导您使用`ink!`编写和部署 ERC20 令牌的基础知识。
...
- [应该在什么时候构建 Axlib runtime 或构建 Axlib 智能合约](https://stackoverflow.com/a/56041305) - 从技术角度回答了开发者什么时候可以选择开发 runtime 或智能合约。
