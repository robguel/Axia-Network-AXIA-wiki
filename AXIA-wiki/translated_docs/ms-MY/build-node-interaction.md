...
- [Axlib RPC API](https://axlib.dev/rustdocs/latest/sc_rpc_api/index.html)
- [AXIA-JS RPC Documentation](https://AXIA.js.org/api/axlib/rpc.html)
- [Axlib API Sidecar](https://github.com/axia-tech/axlib-api-sidecar)
...
Some return values may not appear meaningful at first glance. AXIA uses [SCALE encoding](https://axlib.dev/docs/en/knowledgebase/advanced/codec) as a format that is suitable for resource-constrained execution environments. You will need to decode the information and use the chain [metadata](https://axlib.dev/docs/en/knowledgebase/runtime/metadata) (`state_getMetadata`) to obtain human-readable information.
...
> Note: The Sidecar team is in the process of releasing v1.0.0. As such, there are many breaking changes and new features on the way. Please refer to the [repo](https://github.com/axia-tech/axlib-api-sidecar) for the latest documentation.
