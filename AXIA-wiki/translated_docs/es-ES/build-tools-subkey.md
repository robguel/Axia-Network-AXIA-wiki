...
Subkey is a commandline utility included with Axlib that generates or restores Axlib keys.

`subkey` will use [sr25519](http://wiki.AXIA.network/en/latest/AXIA/learn/cryptography/#keypairs-and-signing) cryptography by default. If you need to use the older ed25519 cryptography to generate or restore your key, or to generate a session key for use by validators, pass the `--ed25519` flag to any of the commands.
