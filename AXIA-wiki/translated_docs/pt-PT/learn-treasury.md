...
- [Axlib's Treasury Pallet](https://github.com/axia-tech/axlib/blob/master/frame/treasury/src/lib.rs) - The Rust implementation of the treasury. ([Docs](https://axlib.dev/rustdocs/v2.0.0-rc4/pallet_treasury/index.html))
