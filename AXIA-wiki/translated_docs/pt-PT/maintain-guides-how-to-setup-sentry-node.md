...
Where `<CHAIN>` will be either `AXIA` for AXIA, `axctcc3` for AXIALunar, or `alphanet2` for AlphaNet.
...
You can use [subkey](https://github.com/axia-tech/axlib/tree/master/bin/utils/subkey) to generate a new `secret_ed25519` as follows:
