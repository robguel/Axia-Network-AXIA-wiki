...
- Download AXIA binary within Ubuntu by running: `curl -sL https://github.com/axia-tech/AXIA/releases/download/v0.8.3/AXIA -o AXIA`
...
- Download AXIA binary by running: `curl -sL https://github.com/axia-tech/AXIA/releases/download/v0.8.3/AXIA -o AXIA`
- Run the following: `sudo chmod +x AXIA`
- Run the following: `./AXIA --name "Your Node Name Here"`
- Find your node at https://telemetry.AXIA.io/#list/AXIALunar
...
```zsh
docker run -p 9944:9944 axia/AXIA:v0.8.3 --name "calling_home_from_a_docker_container"
```
